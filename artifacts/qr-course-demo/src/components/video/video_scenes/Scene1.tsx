    ...
    >
      <AnimatePresence mode="wait">
        {phase < 2 ? (
          ...
          >
            <h1 className="text-4xl font-serif text-primary mb-8 tracking-tight">Formal Logic</h1>
            ...
            <div className="grid grid-cols-3 gap-6 mb-12">
              <div className="col-span-2 flex space-x-6">
                ...
                <div className="flex-1 bg-white border border-border p-6 rounded-xl shadow-sm">
                  ...
                  <div className="text-3xl font-sans font-light">28 <span className="text-muted-foreground text-xl">/ 28</span></div>
                </div>
              </div>
              ...
              <div className="col-span-2">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <h4 className="font-serif text-lg mb-2">Reasoning, arguments, and logical form</h4>
                  ...
                  <div className="bg-white/60 border border-border p-5 rounded-xl opacity-70">
                    ...
                    <h4 className="font-serif text-lg mb-2">Propositional logic</h4>
                    <p className="text-sm text-muted-foreground">6 Lectures · 3 Assignments</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <h1 className="text-4xl font-serif text-primary mb-8 tracking-tight">Week 1 — Reasoning, arguments, and logical form</h1>
              ...
              <div className="divide-y divide-border">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="font-medium">1.1 What logic is: arguments and inference</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.2 Statements, truth, and truth-values</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.4 Deductive and inductive reasoning</span>
                  </div>
                ...
                <div className="px-6 py-4 flex items-center justify-between opacity-80">
                  <div className="flex items-center space-x-4">
                    ...
                    <span>1.5 Logical form and translation</span>
                  </div>
                  <span className="text-xs text-muted-foreground">14 min</span>
                </div>
              </div>
